...
# Defining column indices for numerical and ordinal columns
numerical_column_indices = [4, 5, 6, 7, 8, 9, 10, 11]  # Replace with actual indices for numerical data
ordinal_column_indices = list(range(11, 26))  # Replace with actual indices for ordinal data

numerical_columns = final_df.iloc[:, numerical_column_indices]
ordinal_columns = final_df.iloc[:, ordinal_column_indices]
